...
RLAPI void rlReadDepthBuffer(float* depthData, int width, int height);    // Read depth buffer value at given screen position
...
void rlReadDepthBuffer(float* depthData, int width, int height)
{	
